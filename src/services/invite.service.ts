...
class InviteService {
  ...
  public getInvites = async (take = 10, skip = 10, where?: Prisma.InviteWhereInput, include?: Prisma.InviteInclude) => {
    let filters = {};
  ...
  public updateInvite = async (where: Prisma.InviteWhereUniqueInput, data: Prisma.InviteUpdateInput) => {
